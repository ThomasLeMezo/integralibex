...
void CtcPropagateSegment(C_Polyhedron &volume_in, Pave *pave, vector<C_Polyhedron> &list_volume_out, const std::vector<Generator> &ray_vector_field_list, const std::vector<Generator> &ray_command_list);
