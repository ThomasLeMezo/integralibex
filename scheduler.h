...
/***************** Functions ******************/
public:
    Scheduler(const ibex::IntervalVector &box, const std::vector<ibex::Function *> &f_list, const ibex::IntervalVector &u, bool diseable_singleton);
    Scheduler(const ibex::IntervalVector &box, const vector<ibex::IntervalVector> &remove_boxes, const std::vector<ibex::Function *> &f_list, const ibex::IntervalVector &u, bool diseable_singleton, bool border_in=true, bool border_out=true);
    Scheduler(const ibex::IntervalVector &box, const std::vector<ibex::Function *> &f_list, const ibex::IntervalVector &u, bool diseable_singleton, bool border_in, bool border_out);
    ~Scheduler();
