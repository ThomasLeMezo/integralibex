...
void integration(){
    ...
    vibes::beginDrawing();
    ibex::Variable x, y, z;
    ibex::Function f(x, y, z, Return(10.0*(y-x), 28.0*x-y-x*z, x*z-8.0/3.0*z));
    ...
    activated_pave[0] = ibex::Interval(10.0);
    activated_pave[1] = ibex::Interval(10.0);
    activated_pave[2] = ibex::Interval(10.0);
